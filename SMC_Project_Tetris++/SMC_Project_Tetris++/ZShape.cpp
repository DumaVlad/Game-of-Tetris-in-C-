...
ZShape::ZShape() : TetrisShape(1, 2, Color::Blue)
{
...
void ZShape::ScaleUp()
{
	if ((*this)[{1, 1}].has_value() && (*this)[{2, 3}].has_value())
	{
		(*this)[{2, 3}].reset();
		(*this)[{1, 0}] = 1;
		(*this)[{3, 2}] = 1;
	...
	if ((*this)[{3, 1}].has_value() && (*this)[{1, 2}].has_value())
	{
		(*this)[{1, 2}].reset();
		(*this)[{4, 1}] = 1;
		(*this)[{2, 3}] = 1;
	...
	if ((*this)[{2, 1}].has_value() && (*this)[{3, 3}].has_value())
	{
		(*this)[{2, 1}].reset();
		(*this)[{1, 0}] = 1;
		(*this)[{3, 4}] = 1;
	...
	if ((*this)[{3, 2}].has_value() && (*this)[{1, 3}].has_value())
	{
		(*this)[{3, 2}].reset();
		(*this)[{4, 1}] = 1;
		(*this)[{3, 1}] = 1;
...
void ZShape::ScaleDown()
{
	if ((*this)[{1, 0}].has_value() && (*this)[{3, 4}].has_value())
	{
		(*this)[{2, 3}] = 1;
		(*this)[{1, 0}].reset();
		(*this)[{3, 2}].reset();
	...
	if ((*this)[{4, 1}].has_value() && (*this)[{0, 3}].has_value())
	{
		(*this)[{1, 2}]=1;
		(*this)[{4, 1}].reset();
		(*this)[{2, 3}].reset();
